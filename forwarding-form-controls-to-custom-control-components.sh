...
Primary discussion list for GNU Wget <bug-wget.gnu.org>
List Subscribe:
https://lists.gnu.org/mailman/listinfo/bug-wget, 
mailto:bug-wget-request@gnu.org?subject=subscribe
mailto:bug-wget@gnu.org
...
This is the top part of the downloaded file:
...
Hi, Wget isn't guilty. I've saved it from Firefox and the same thing happens... except if there is no Internet access... so I'm pretty sure it's one of the numerous scripts of this bloated Website...
